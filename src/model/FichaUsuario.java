 ...
 */
@WebServlet(description = "Primer Servlet", urlPatterns = { "/FichaUsuario" })
public class FichaUsuario extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			int idUsuario = RequestUtils.getIntParameterFromHashMap(hashMap, "idConcesionario"); // Necesito obtener el id del profesor que se quiere editar. En caso de un alta
